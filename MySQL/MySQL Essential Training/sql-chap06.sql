...
USE scratch;
SELECT "name", "address" FROM customer;				-- This query list the records with the same values "name" and "address"
SELECT `name`, `address` FROM customer;				-- This query is the same as SELECT name, address FROM customer;
